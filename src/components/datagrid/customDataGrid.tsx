...
export function filterTypeClassName(
  params: GridCellParams<FilterType> | FilterType
) {
  let filterType =
    (params as GridCellParams<FilterType>).value || (params as FilterType);

  return `filter-type-${filterType}`;
}

const onTypeCellClick = (

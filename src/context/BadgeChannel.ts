...
export const BadgeListChannelContext = createContext<
  | {
      badgeListChannel: BadgeChannelType;
      setBadgeListChannel: React.Dispatch<
        React.SetStateAction<BadgeChannelType>
      >;
    }
  | undefined
>(undefined);
export const BadgeChannelNameContext = createContext<
  | {
...
export function useBadgeListChannelContext() {
  ...
  if (typeof context === "undefined") {
    throw new Error(
      "BadgeListChannelContext must be within BadgeListChannelProvider"
    );
  }
...
export function useBadgeChannelNameContext() {
  ...
  if (typeof context === "undefined") {
    throw new Error(
      "BadgeChannelNameContext must be within BadgeChannelNameProvider"
    );
  }
